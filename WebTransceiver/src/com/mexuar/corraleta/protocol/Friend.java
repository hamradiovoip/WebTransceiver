 ...
 * @version $Revision: 1.27 $ $Date: 2006/05/17 11:14:24 $
 */
public class Friend extends java.util.TimerTask {

    private final static String version_id =
            "@(#)$Id: Friend.java,v 1.27 2006/05/17 11:14:24 uid1003 Exp $ Copyright Mexuar Technologies Ltd";
    ...
    public void tellGuigotText(String str) {
        ProtocolEventListener ges = _binder.getGuiEventSender(_gui);
        ges.gotText(this,str);
    }

    public void tellGuirxKeyChange(boolean keyed) {
        ProtocolEventListener ges = _binder.getGuiEventSender(_gui);
        ges.rxKeyChange(this,keyed);
    }
     ...
     * Called by timer.
     */
    public void run() { Log.debug("run():addNewwaitingack");
        // start the process off by creating a special Call.
        if (_regcall == null) {

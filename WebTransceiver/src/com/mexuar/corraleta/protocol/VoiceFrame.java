 ...
 * @version $Revision: 1.18 $ $Date: 2006/11/16 10:55:38 $
 */
public class VoiceFrame extends FullFrame {

    private final static String version_id =
            "@(#)$Id: VoiceFrame.java,v 1.18 2006/11/16 10:55:38 uid100 Exp $ Copyright Mexuar Technologies Ltd";
    ...
    void arrived() throws IAX2ProtocolException {
        ...
        try {
            ...
            _call.audioWrite(bs, this.getTimestampVal() & 0xffff ); System.out.println("voice frame audioWrite called ms="+System.currentTimeMillis());
        }

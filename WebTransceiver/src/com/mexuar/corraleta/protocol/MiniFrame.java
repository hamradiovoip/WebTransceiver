...
public class MiniFrame extends Frame {
    ...
    private final static String version_id =
            "@(#)$Id: MiniFrame.java,v 1.15 2006/05/12 14:14:13 uid100 Exp $ Copyright Mexuar Technologies Ltd";
    ...
    void arrived() throws IAX2ProtocolException {
        ...
        if (dr < fsz) {
            ...
            _data.get(bs);
            try {
                _call.audioWrite(bs, ts); System.out.println(" miniframe audioWrite called ms="+System.currentTimeMillis());
            }
